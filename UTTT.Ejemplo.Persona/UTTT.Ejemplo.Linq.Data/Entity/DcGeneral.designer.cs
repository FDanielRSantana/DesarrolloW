...
namespace UTTT.Ejemplo.Linq.Data.Entity
{
	...
	public partial class Persona : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _strCElectronico;
    ...
    partial void OnstrCElectronicoChanging(string value);
    partial void OnstrCElectronicoChanged();
    ...
    partial void OnstrRFCChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_strCElectronico", DbType="VarChar(50)")]
		public string strCElectronico
		{
			get
			{
				return this._strCElectronico;
			}
			set
			{
				if ((this._strCElectronico != value))
				{
					this.OnstrCElectronicoChanging(value);
					this.SendPropertyChanging();
					this._strCElectronico = value;
					this.SendPropertyChanged("strCElectronico");
					this.OnstrCElectronicoChanged();
				}
			}
		}
