        ...
        <div>
             ...
             <asp:GridView ID="dgvPersonas" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="dteFechaNacimiento" HeaderText="fechaNacimiento" ReadOnly="True" SortExpression="dteFechaNacimiento" />
                   

                    <asp:BoundField DataField="strCElectronico" HeaderText="Correo electronico" ReadOnly="True" SortExpression="strCElectronico" />
